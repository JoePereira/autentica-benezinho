...
@Table(name = "TB_SISTEMA", uniqueConstraints = {
        @UniqueConstraint(name = "UK_SISTEMA_SG", columnNames = "SG_SISTEMA")
} )
    ...
    @JoinTable(
            ...
            joinColumns = {
                    @JoinColumn(
                            ...
                            foreignKey = @ForeignKey(name = "FK_SISTEMA_RESPONSAVEL")
                    )
            },
            inverseJoinColumns = {
                    @JoinColumn(
                            ...
                            foreignKey = @ForeignKey(name = "FK_RESPONSAVEL_SISTEMA")
                    )
            }
    )
